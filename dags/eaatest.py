...
email_failure = EmailOperator(
        ...
        to=f'amesegue@akamai.com,{username}@akamaipartnertraining.com',
...
email_success = EmailOperator(
        ...
        html_content=f'<h4>Congratulations!<h4>  You have successfully passed the practical examination component of the Akamai Advanced Partner Ion Certification.\
